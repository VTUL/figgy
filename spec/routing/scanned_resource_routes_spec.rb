...
RSpec.describe "Scanned Resource Routes" do
  it "routes nested record creates appropriately" do
    ...
    expect(get("/concern/scanned_resources/1")).to route_to("scanned_resources#show", id: "1")
    expect(get("/concern/multi_volume_works/1")).to route_to("scanned_resources#show", id: "1")
  end
end
